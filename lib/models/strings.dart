...
const userName_error = "user name already exists please choose another.";
...
const terms_and_conditions_error = "Please Accept our terms and conditions";
const investment_name_error = "Investment name is not valid";
