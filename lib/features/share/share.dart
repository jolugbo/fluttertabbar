                          ...
                          children: <Widget>[
                            ...
                            Container(
                              //height: MediaQuery.of(context).size.height * 0.15,
                                ...
                                alignment: Alignment.center,
                                child: Text('Invite your friends to join Project X community and earn points',textAlign: TextAlign.center,style: dark20Style,)
                            ),
                            Container(
                              height: MediaQuery.of(context).size.height * 0.1,
                            ),
                                  ...
                                  child: RaisedButton(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(' Share with friends',style: light18Style,),
                                        Text('')
                                      ],
                                    ),
                                    onPressed: () => {
                                    Share.share('check out my website https://example.com', subject: 'hey friend take a look at this cool app!')
