...
export const dBase = {careers: baseStore.collection("careers"), users: baseStore.collection("users"), courses: baseStore.collection("courses"), universities: baseStore.collection("universities")};
